...
if __name__ == "__main__":
    ...
    for index, y in enumerate(data):
        if index == 4 or index == 2 or index==3:
            continue
    ...
    ax.set_ylabel("Matching profit", fontsize=32, fontproperties='Times New Roman'
                  #, fontweight='bold'
                  )
    ...
    plt.legend([ 'RL', 'epsilon=0.3', 'p-0.5'],prop={'size': 32, 'family': 'Times New Roman'},)
    fig.tight_layout()
    plt.grid(True, linestyle=':',alpha=0.6)
    plt.savefig('./pic/bar_matching_profit.png'
                # , format='pdf'
                , bbox_inches='tight'
